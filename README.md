<div align="center"><h1>Luma Mini Shell Bypass</h1></div>
<br>
<div align="center">
...
in order for the bypass function to work you need to ensure that the mail(), putenv() & mb_send_mail() functions are enabled.<br>
